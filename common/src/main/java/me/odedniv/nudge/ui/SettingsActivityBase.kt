...
abstract class SettingsActivityBase : ComponentActivity() {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    setContent {
      ...
      Content(
        value = settings,
        onUpdate = {
          if (it.requestPermissions()) return@Content
  ...
  private fun Settings.requestPermissions(): Boolean {
    if (requiresAlarm && !canScheduleExactAlarm) {
    ...
    if (requiresNotifications && !canPostNotifications) {
      pendingSettings.set(this)
